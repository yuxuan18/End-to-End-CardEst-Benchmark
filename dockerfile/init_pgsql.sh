...
echo "listen_addresses = 'localhost'" >> /var/lib/pgsql/13.1/data/postgresql.conf

sed -i 's/max_wal_size = 1GB/max_wal_size = 4GB/g' /var/lib/pgsql/13.1/data/postgresql.conf
sed -i 's/shared_buffers = 128MB/shared_buffers = 256MB/g' /var/lib/pgsql/13.1/data/postgresql.conf
